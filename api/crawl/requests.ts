...
/*
GET /api/v1/crawl/targets — 설정된 크롤 대상 + 등록된 크롤러 목록.
...
/*
GET /api/v1/crawl/targets/{target_key} — 크롤 대상 상세. url 등 크롤러별 설정을
...
/*
POST /api/v1/crawl/targets — 크롤 대상 등록. 같은 kind 안에서 id가 이미 있으면 409.
*/
...
/*
PUT /api/v1/crawl/targets/{target_key} — label/crawler/크롤러별 설정을 전체
...
/*
DELETE /api/v1/crawl/targets/{target_key} — 크롤 대상을 삭제한다. 걸려 있는
...
/*
POST /api/v1/crawl/preview — 선택한 크롤러를 실제 크롤 경로 그대로 실행해 결과를
...
/*
GET /api/v1/crawl/jobs — 최근 작업 목록. 실행 중인 작업이 있으면 폴링으로
진행 상황을 갱신한다.
*/
...
/*
POST /api/v1/crawl/jobs — 크롤 동기화 작업을 생성하고 백그라운드로 실행한다.
...
/*
GET /api/v1/crawl/schedules — 등록된 전체 대상의 스케줄 목록.
*/
...
/*
PUT /api/v1/crawl/schedules/{target_key} — 등록된 대상 하나의 스케줄 변경.
...
/*
DELETE /api/v1/crawl/schedules/{target_key} — 등록된 대상 하나의 스케줄 삭제.
